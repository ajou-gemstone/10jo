...
public interface ChattingService {
    ...
    Call<List<Group>> getchattinginfo(@Path("chattinginfo") String chattinginfo);

    @GET("/chattinglist/{chattinglist}")
    Call<List<Group>> getchattinglist(@Path("chattinglist") String chattinglist);

    @GET("/chattingnum/{chattingnum}")
    Call<List<Group>> getchattingnum(@Path("chattingnum") String chattingnum);
